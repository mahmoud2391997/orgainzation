...
```bash
sudo -u postgres createuser --pwprompt baytfix
sudo -u postgres createdb -O baytfix baytfix
```
...
3. **`20260715120000_seed_products.sql`** — Pre-seed electrical, plumbing, and inspection jobs
...
1. **products** (16 jobs pre-seeded)
   - Tiered pricing: homeowner, building, contractor
   - Categories: electrical, plumbing, inspection
