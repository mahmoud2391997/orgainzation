...
async function seedDatabase() {
  try {
    ...
    const messages = [
      { conversation_id: conversations.data[0].id, sender: 'customer', text: 'مرحبا، أريد إصلاح فيش وإصلاح حنفية', time: '09:30 AM', type: 'order_request' },
      ...
      { conversation_id: conversations.data[1].id, sender: 'customer', text: 'السلام عليكم، نحتاج صيانة دورية لكهرباء وسباكة العمارة', time: '10:15 AM', type: 'inquiry' },
      { conversation_id: conversations.data[1].id, sender: 'bot', text: 'أهلا! نحن نوفر أسعار خاصة للعمارات', time: '10:16 AM', type: 'greeting' },
      { conversation_id: conversations.data[2].id, sender: 'customer', text: 'نحتاج صيانة كهرباء وسباكة لعدة وحدات', time: '11:00 AM', type: 'inquiry' },
      { conversation_id: conversations.data[2].id, sender: 'bot', text: 'مرحبا! نحن نوفر أسعار خاصة للمقاولين', time: '11:01 AM', type: 'menu_link' },
    ];
    ...
    const orderItems = await supabase.from('order_items').insert([
      // Order 1
      { order_id: 'ORD-001', product_name: 'Outlet Repair', qty: 2, unit: 'visit', unit_price: 2.50 },
      { order_id: 'ORD-001', product_name: 'Light Fixture Install', qty: 3, unit: 'piece', unit_price: 1.50 },
      { order_id: 'ORD-001', product_name: 'Faucet Repair', qty: 2, unit: 'visit', unit_price: 1.80 },
      // Order 2
      { order_id: 'ORD-002', product_name: 'Carrot', qty: 5, unit: 'visit', unit_price: 1.50 },
      { order_id: 'ORD-002', product_name: 'Spinach', qty: 2, unit: 'visit', unit_price: 2.00 },
      { order_id: 'ORD-002', product_name: 'Broccoli', qty: 3, unit: 'piece', unit_price: 2.75 },
      // Order 3
      { order_id: 'ORD-003', product_name: 'Outlet Repair', qty: 20, unit: 'visit', unit_price: 2.00 },
      { order_id: 'ORD-003', product_name: 'Onion', qty: 15, unit: 'visit', unit_price: 0.90 },
      { order_id: 'ORD-003', product_name: 'Bell Pepper', qty: 10, unit: 'visit', unit_price: 2.80 },
      { order_id: 'ORD-003', product_name: 'Light Fixture Install', qty: 50, unit: 'piece', unit_price: 1.20 },
      // Order 4
      { order_id: 'ORD-004', product_name: 'Outlet Repair', qty: 50, unit: 'visit', unit_price: 1.50 },
      { order_id: 'ORD-004', product_name: 'Onion', qty: 30, unit: 'visit', unit_price: 0.70 },
      { order_id: 'ORD-004', product_name: 'Carrot', qty: 25, unit: 'visit', unit_price: 0.85 },
      { order_id: 'ORD-004', product_name: 'Leak Repair', qty: 20, unit: 'visit', unit_price: 2.50 },
      { order_id: 'ORD-004', product_name: 'Orange', qty: 15, unit: 'visit', unit_price: 1.80 },
      { order_id: 'ORD-004', product_name: 'Mint', qty: 10, unit: 'visit', unit_price: 0.60 },
      { order_id: 'ORD-004', product_name: 'Parsley', qty: 8, unit: 'visit', unit_price: 0.70 },
    ]).select();
