...
const quickPrompts = [
  'مرحبا',
  'أطلب لنفسي',
  '2 إصلاح فيش و 1 إصلاح حنفية',
  'أريد إصلاح فيش وإصلاح حنفية',
  'نعم أريد التأكيد',
  'الدفع عند الاستلام',
    ...
    <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm flex flex-col" style={{ height: 520 }}>
      ...
      <div className="px-4 py-3 bg-[#075E54] flex items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <option value="retail" className="text-gray-900">Homeowner</option>
            <option value="shop" className="text-gray-900">Building</option>
            <option value="restaurant" className="text-gray-900">Contractor</option>
          </select>
