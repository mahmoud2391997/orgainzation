...
export const CUSTOMER_TYPE_LABELS: Record<CustomerType, { en: string; ar: string }> = {
  retail: { en: 'Homeowner', ar: 'مالك منزل' },
  shop: { en: 'Building', ar: 'عمارة' },
  restaurant: { en: 'Contractor', ar: 'مقاول' },
};
